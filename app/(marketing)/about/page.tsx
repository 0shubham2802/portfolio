...
export const metadata: Metadata = {
  ...
  description:
    "Backend engineer based in Bengaluru, designing distributed systems in Java and Spring Boot. Background, stack, and timeline.",
};
    ...
    <section className="enter-fade-up space-y-14 pt-8">
      ...
      <div className="space-y-4">
        <p className="max-w-2xl text-[16px] leading-[1.65] text-ink-secondary">
          Shubham is a backend engineer based in Bengaluru, India, focused on
